...
<div id="Catalog">
	...
	<table>
		<tr>
			<td>User ID:</td>
			<td><input type="text" name="username" id="username" onblur="checkUserName();" required="required"/><span id="isExist"></span></td>
		</tr>
		<tr>
			<td>New password:</td>
			<td><input type="password" name="password" id="password" required="required" onblur="checkPassword();"/></td>
		</tr>
		<tr>
			<td>Repeat password:</td>
			<td><input type="password" name="repeatedPassword" id="repeatedPassword" onblur="checkPassword();" required="required"/><span id="notEqual"></span></td>
		</tr>
		<tr>

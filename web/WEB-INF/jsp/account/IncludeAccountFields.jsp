...
<table>
	<c:if test="${sessionScope.account!=null}">
		...
		<tr>
			<td>Address 1:</td>
			<td><input type="text" name="account.address1" size="40" value="${sessionScope.account.address1}"/></td>
		</tr>
		<tr>
			<td>Address 2:</td>
			<td><input type="text" name="account.address2" size="40" value="${sessionScope.account.address2}"/></td>
		</tr>
		<tr>
			<td>City:</td>
		...
		<tr>
			<td>State:</td>
			<td><input type="text" name="account.state" size="4" value="${sessionScope.account.state}"/></td>
		</tr>
		<tr>
			<td>Zip:</td>
			<td><input type="text" name="account.zip" size="10" value="${sessionScope.account.zip}"/></td>
		</tr>
		<tr>
			<td>Country:</td>
			<td><input type="text" name="account.country" size="15" value="${sessionScope.account.country}"/></td>
		</tr>
		</table>
	...
	<c:if test="${sessionScope.account==null}">
		<tr>
			<td>First name:</td>
			<td><input type="text" name="account.firstName" required="required"/></td>
		</tr>
		<tr>
			<td>Last name:</td>
			<td><input type="text" name="account.lastName" required="required"/></td>
		</tr>
		<tr>
			<td>Email:</td>
			<td><input type="text" name="account.email" required="required"/></td>
		</tr>
		<tr>
			<td>Phone:</td>
			<td><input type="text" name="account.phone" required="required"/></td>
		</tr>
		<tr>
			<td>Address 1:</td>
			<td><input type="text" name="account.address1" size="40" required="required"/></td>
		</tr>
		<tr>
			<td>Address 2:</td>
			<td><input type="text" name="account.address2" size="40" required="required"/></td>
		</tr>
		<tr>
			<td>City:</td>
			<td><input type="text" name="account.city" required="required"/></td>
		</tr>
		<tr>
			<td>State:</td>
			<td><input type="text" name="account.state" size="4" required="required"/></td>
		</tr>
		<tr>
			<td>Zip:</td>
			<td><input type="text" name="account.zip" size="10" required="required"/></td>
		</tr>
		<tr>
			<td>Country:</td>
			<td><input type="text" name="account.country" size="15" required="required"/></td>
		</tr>
		</table>
